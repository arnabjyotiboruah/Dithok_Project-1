var app = angular.module('editUsersApp', []);
...
app.controller('editUsersCtrl', function ($scope, $http, myFactory) {
    $scope.userData = {}; //TODO: it will contain nested object
    $scope.editUserRespData = {};

    // this editUser.html is called to search and edit user details. So phone parameter is passed to it to search
    $scope.email = new URLSearchParams(document.location.search).get("phone");
